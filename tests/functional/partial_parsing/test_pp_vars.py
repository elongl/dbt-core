...
from tests.functional.partial_parsing.fixtures import (
    model_color_sql, env_var_model_sql, env_var_schema_yml, env_var_model_one_sql,
    raw_customers_csv, env_var_sources_yml, test_color_sql, env_var_schema2_yml,
    env_var_schema3_yml, env_var_macro_sql, env_var_macros_yml, env_var_model_test_yml,
    people_sql, env_var_metrics_yml, model_one_sql,
)
